...
if(typeof localStorage!='undefined') {
	...
	if(date_save === date_today){
		...
		//Sinon, on actualise la variable et on load Edge
		localStorage.setItem('datesave', date_today);
		
		loadjscssfile("lib/edge/edge_style.css", "css");
		...
		(function(compId){
			...
			aLoader = [
		      { load: folder + "edge_includes/jquery-2.0.3.min.js"},
		      { load: folder + "edge_includes/edge.4.0.0.min.js"},
		      { load: folder + "newweb_edge.js"},
		      { load: folder + "newweb_edgeActions.js"}];
			...
			var plSTF="width",ctrPlS="both",minPlW="0",maxPlW="550px",plWidth="550px",plHeight="400px";
			...
			loadjscssfile("lib/edge/animation_display.js", "js");
			setTimeout(function(){
				loadjscssfile("js/main.js", "js");
			}, 3000);
	}
